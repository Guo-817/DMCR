...
class DataHandler(object):
    def __init__(self, dataset, batch_size):
        ...
        elif self.dataset_name.find('TripAdvisor') != -1:
            cris = ['value', 'service', 'rooms', 'location', 'cleanliness', 'checkin', 'business', 'train']
        elif self.dataset_name.find('RateBeer') != -1:
            cris = ['appearance', 'aroma', 'palate', 'taste', 'train']
        elif self.dataset_name.find('Yelp2022') != -1:
            cris = ['funny', 'cool', 'useful']
        elif self.dataset_name.find('BeerAdvocate') != -1:
            cris = ['appearance', 'aroma', 'palate', 'taste', 'train']
        elif self.dataset_name.find('RB-Extended') != -1:
            cris = ['appearance', 'aroma', 'palate', 'taste', 'train']

        self.predir = '../dataset/' + self.dataset_name
        self.cris = cris
        self.beh_num = len(cris)
